...
<body style="background-image: url('/bootstrap/assets/img/monkeyBG.png');background-repeat: repeat;background-color: white ;background-size: 10%;">
    ...
    <script src="/bootstrap/assets/js/stylish-portfolio.js"></script>
</body>
</html>